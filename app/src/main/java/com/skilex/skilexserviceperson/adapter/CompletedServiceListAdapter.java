...
public class CompletedServiceListAdapter extends BaseAdapter {

    //    private final Transformation transformation;
    private Context context;
    private ArrayList<CompletedService> services;
...
//                .build();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final CompletedServiceListAdapter.ViewHolder holder;
//        ViewHolder holder;
        if (convertView == null) {
            LayoutInflater inflater = ((Activity) context).getLayoutInflater();
            convertView = inflater.inflate(R.layout.completed_service_list_item, parent, false);

            holder = new CompletedServiceListAdapter.ViewHolder();
...
//            }
            ...
            holder.txtExpert.setText(services.get(position).getServiceAssociateName());
            holder.txtStatus = convertView.findViewById(R.id.service_status);
            holder.txtStatus.setText(services.get(position).getPaymentStatus());
            convertView.setTag(holder);

        } else {
            holder = (CompletedServiceListAdapter.ViewHolder) convertView.getTag();
