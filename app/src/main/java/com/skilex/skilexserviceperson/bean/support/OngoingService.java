...
public class OngoingService implements Serializable {
    ...
    @Expose
    private String service_expert_name;
     ...
     */
    public String getServiceExpertName() {
        return service_expert_name;
    }

    /**
     * @param service_expert_name The service_expert_name
     */
    public void setServiceExpertName(String service_expert_name) {
        this.service_expert_name = service_expert_name;
    }
}
